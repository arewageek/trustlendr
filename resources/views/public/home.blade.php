...
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="logo-img">
                        <ul class="d-flex justify-content-between">
                            <li> <a href="https://imgbb.com/"><img src="https://i.ibb.co/qRcTbmP/image1.png"
                                        alt="image1"></a></li>
                            <li><a href="https://imgbb.com/"><img src="https://i.ibb.co/FhRvMWR/image2.png" alt="image2"
                                        border="0"></a></li>
                            <li><a href="https://imgbb.com/"><img src="https://i.ibb.co/gPtbxr4/image3.png" alt="image3"
                                        border="0"></a></li>
                            <li><a href="https://imgbb.com/"><img src="https://i.ibb.co/2SbJcK5/image5.png" alt="image5"
                                        border="0"></a></li>
                            <li><a href="https://imgbb.com/"><img src="https://i.ibb.co/85bNd72/image4.png" alt="image4"
                                        border="0"></a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-image">
                        <a href="https://imgbb.com/"><img src="imagesc/images (4).jpg" alt="about"
                                border="0"></a>
                ...
                <div class="col-lg-6">
                    <div class="about-text">
                        <div class="finix-text">
                            <h6>About creditscore</h6>
                            <h2>We have been working very efficiently with loan and funding for 25 years.<h2>
                                    <p>access credit base on your blockchaing activities </p>
                                    <strong> we focus on 3 things.</strong>
                                    <ul>
                                        <li>Useful info</li>
                                        <li>Reliability</li>
                                        <li>consistency </li>
    ...
    <section class="why-choose-us gray-bg py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="why-choose-text">
                        <div class="finix-text">
                            ...
                            <h2>Why people choose us<h2>
                                    <p>seemlesss easy access to your finacial detail </p>
                                    <img src="imagesc/images (7).jpg" alt="choose">
                ...
                <div class="col-lg-6">
                    <div class="row choose-items">
                        ...
                        <div class="col-lg-6">
                            <div class="choose-item text-center mt-4">
                                <div class="choose-icon">
                                    <i class="fas fa-percent"></i>
                                </div>
                                <h3 class="py-4">Guarantee</h3>
                                <p> your best and easy access to funds and reports </p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="choose-item text-center mtop4">
                                <div class="choose-icon">
                                    <i class="fas fa-percent"></i>
                                </div>
                                <h3 class="py-4">Experience</h3>
                                <p>simple and seemless access </p>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="finix-text text-center">
                    ...
                    <h2>You deserve a better access loan</h2>
                    <p>blockchain the new way of doing transaction</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="apply-now-left-side mt-5">
                        <h2 class="mb-4">We usually follow 4 steps to get a better access to loans.</h2>
                        <div class="step-timeline">
                            <ul>
                                ...
                                <li data-counter="2">
                                    <strong> Hear from us in less then 5 minutes </strong>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt ut labore et dolore magna aliqua.</p>
                                </li>
                                <li data-counter="3">
                                    <strong>A decision in 1 hours</strong>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt ut labore et dolore magna aliqua.</p>
                                </li>
                                <li data-counter="4">
                ...
                <div class="col-lg-6 py-5" id="loan">
                        ...
                        <div class="calculate-form">
                            <form action="#">
                                <div class="form-group">
                                    <label for="type-money">The lender ____interest rate ____minimum creditscore requriment</label>
                                    <select class="form-select" aria-label="Default select example">
                                        <option selected>Fair money____20%_____350% </option>
                                        <option value="1">monie point   10%</option>
                                        <option value="2">CArbon</option>
                                        <option value="3">Branch</option>
                                        <option value="4">Okash</option>
                                ...
                                <div class="form-group">
                                    <label for="type-money">BVN or Blockchain ID</label>
                                    <input type="text" class="form-control" id="type money" aria-describedby="helpId"
                                        placeholder="222222">

                                </div>
                                <div class="form-group">
                                    <label for="type-money">Type The Money</label>
                                    <input type="text" class="form-control" id="type money" aria-describedby="helpId" placeholder="NGN11200">
                                
                                </div>

                                <div class="form-group">
                                    <label for="type-money">Select The Month/Years</label>
                                    <select class="form-select" aria-label="Default select example">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="Borrowing" aria-describedby="helpId"
                                        placeholder="6 Month">
                                </div>

                                <div class="form-group">
                                    <label for="type-total">The Total You Will Pay</label>
                                    <input type="text" class="form-control" id="type total" aria-describedby="helpId"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <div class="call-to-action-phone d-flex">
                            ...
                            <a href="tel:+7035422345">7035422345</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="our-company-img">
                        <img src="imagesc/images.jpg" alt="company2">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="services-section gray-bg py-5">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="finix-text text-center">
                        ...
                        <h2 class=" font-weight-bold">Only the best professional services</h2>
                ...
                <div class="col">
                    <div class="services-tab mt-5">
                        <ul class="nav mb-3 text-center services-tab-item" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-home-tab" data-toggle="pill"
                                    href="#pills-Agricultural" role="tab" aria-controls="pills-home"
                                    aria-selected="true">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-Personal"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-Business"
                                    role="tab" aria-controls="pills-contact" aria-selected="false">
                                    <span class="d-block"><i class="fab fa-amazon-pay    "></i></span>
                                    <strong class="d-block">Business Loan</strong>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-Educational"
                                    role="tab" aria-controls="pills-contact" aria-selected="false">
                                    <span class="d-block"><i class="fas fa-archive    "></i></span>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-Agricultural" role="tabpanel"
                                aria-labelledby="pills-home-tab">
                                <div class="services-tab-content">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <img src="imagesc/btc.png" alt="services-tab">
                                        </div>
                                        <div class="col-lg-6">
                            ...
                            <div class="tab-pane fade" id="pills-Personal" role="tabpanel"
                                ...
                                <div class="services-tab-content">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <img src="https://i.ibb.co/47gq67j/services-tab.png" alt="services-tab">
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="service-tab-content-text">
                                                <h3>Personal loan</h3>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="testimonial-image">
                        <img src="imagesc/download.jpg" alt="man">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- <section class="team-section gray-bg py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-2"></div>
                <div class="col-lg-8">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="team-member">
                        <div class="member-image">
                            <img src="https://i.ibb.co/0mQS84Z/image1.jpg" alt="image1">
                ...
                <div class="col-lg-3">
                    <div class="team-member">
                        <div class="member-image">
                            <img src="https://i.ibb.co/FXhpZGg/image2.jpg" alt="image2">
                            <div class="member-social-profile">
                                <ul>
                ...
                <div class="col-lg-3">
                    <div class="team-member">
                        <div class="member-image">
                            <img src="https://i.ibb.co/3RPN5qm/image3.jpg" alt="image3">
                            <div class="member-social-profile">
                                <ul>
                ...
                <div class="col-lg-3">
                    <div class="team-member">
                        <div class="member-image">
                            <img src="https://i.ibb.co/SvsFV0G/image4.jpg" alt="image4">
                            <div class="member-social-profile">
                                <ul>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="blog-item">
                        <div class="blog-thumbnail">
                            <img src="imagesc/images.jpg" alt="image1-1">
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="blog-item">
                        <div class="blog-thumbnail">
                            <img src="imagesc/download.jpg" alt="image2-1">
                        </div>
                        <div class="blog-content">
                            <p>July 04, 2020</p>
                ...
                <div class="col-lg-4">
                    <div class="blog-item">
                        <div class="blog-thumbnail">
                            <img src="imagesc/btc.png" alt="image3-1">
                        </div>
                        <div class="blog-content">
                            <p>July 03, 2020</p>
